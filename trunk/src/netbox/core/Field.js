...
/** Implements the field class.
  ...
  */
Ext.define('Ext.ux.netbox.core.Field', {
	extend: 'Ext.util.Observable', 
	constructor: function(id,labelIn,defaultValues) {
 ...
 getElementaryFilterInstance : function(operator){
    var filter=Ext.create('Ext.ux.netbox.core.ElementaryFilter',this,operator);
    return filter;
  },
